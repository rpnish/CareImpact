...
export default function CompanyPlanDropdown({
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-5 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 shadow-sm">
        ...
        <div className="flex-1 relative min-w-[220px]">
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-slate-950 border border-slate-750 text-white text-xs sm:text-sm font-bold rounded-xl px-3.5 py-2.5 pr-8 appearance-none focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all cursor-pointer shadow-sm"
            >
              {companies.map((c) => (
          ...
          <div className="flex-1 relative min-w-[200px]">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-slate-950 border border-slate-750 text-white text-xs sm:text-sm font-bold rounded-xl px-3.5 py-2.5 pr-8 appearance-none focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition-all cursor-pointer"
              >
                <option value="ALL">
      ...
      {/* Active Scope Badge */}
      {currentCompany && (
        <div className="flex items-center gap-3 bg-slate-950 px-4 py-2.5 rounded-xl border border-slate-800 self-stretch md:self-auto justify-between md:justify-end">
          <div className="text-left">
            <span className="text-[10px] uppercase font-bold text-slate-400 block">Plan Ownership</span>
          ...
          <div className="text-right font-mono">
            <span className="text-[10px] uppercase font-bold text-slate-400 block">Plan Star Rating</span>
            <span className={`text-sm font-black ${currentCompany.performance.textClass}`}>
